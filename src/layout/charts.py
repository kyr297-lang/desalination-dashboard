...
def make_chart_section() -> html.Div:
    ...
    slider_explanation = html.P(
        ...
        "affect system performance. Source Water Salinity (TDS) controls the "
        "dissolved solids concentration of the feedwater, which directly determines "
        "the energy required for reverse osmosis membrane separation. Groundwater "
        "Well Depth sets the vertical lift distance for extraction pumps, scaling "
        "their power demand proportionally. Adjusting these parameters updates "
        "the cost and energy charts in real time for all three system configurations.",
        className="text-muted small no-print",
