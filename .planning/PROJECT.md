...
An interactive dashboard built with Python (Dash/Plotly) that lets engineering students explore and compare three wind-powered desalination system configurations — mechanical (hydraulic drive), electrical (battery storage), and hybrid — for a municipality of ~10,000 people. Features side-by-side comparison charts, a RAG scorecard, interactive salinity/depth energy sliders, system architecture diagrams, and a project landing page with contributor context.
